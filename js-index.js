...
function updateLooksModifiers() {
	if (looks.abilityScore >= 1 && looks.abilityScore < 2) {
		looks.charismaModifier = "-6";
		looks.startingHonorModifier = "-6";
		looks.startingFameModifier = "+9";
	} else if (looks.abilityScore >= 2 && looks.abilityScore < 3) {
		looks.charismaModifier = "-5";
		looks.startingHonorModifier = "-5";
		looks.startingFameModifier = "+6";
	} else if (looks.abilityScore >= 3 && looks.abilityScore < 4) {
		looks.charismaModifier = "-5";
		looks.startingHonorModifier = "-4";
		looks.startingFameModifier = "+4";
	} else if (looks.abilityScore >= 4 && looks.abilityScore < 5) {
		looks.charismaModifier = "-4";
		looks.startingHonorModifier = "-3";
		looks.startingFameModifier = "+2";
	} else if (looks.abilityScore >= 5 && looks.abilityScore < 6) {
		looks.charismaModifier = "-3";
		looks.startingHonorModifier = "-3";
		looks.startingFameModifier = "+1";
	} else if (looks.abilityScore >= 6 && looks.abilityScore < 7) {
		looks.charismaModifier = "-2";
		looks.startingHonorModifier = "-2";
		looks.startingFameModifier = "+1";
	} else if (looks.abilityScore >= 7 && looks.abilityScore < 8) {
		looks.charismaModifier = "-2";
		looks.startingHonorModifier = "-2";
		looks.startingFameModifier = "0";
	} else if (looks.abilityScore >= 8 && looks.abilityScore < 9) {
		looks.charismaModifier = "-1";
		looks.startingHonorModifier = "-1";
		looks.startingFameModifier = "0";
	} else if (looks.abilityScore >= 9 && looks.abilityScore < 10) {
		looks.charismaModifier = "-1";
		looks.startingHonorModifier = "-1";
		looks.startingFameModifier = "0";
	} else if (looks.abilityScore >= 10 && looks.abilityScore < 11) {
		looks.charismaModifier = "0";
		looks.startingHonorModifier = "0";
		looks.startingFameModifier = "0";
	} else if (looks.abilityScore >= 11 && looks.abilityScore < 12) {
		looks.charismaModifier = "0";
		looks.startingHonorModifier = "0";
		looks.startingFameModifier = "0";
	} else if (looks.abilityScore >= 12 && looks.abilityScore < 13) {
		looks.charismaModifier = "0";
		looks.startingHonorModifier = "+1";
		looks.startingFameModifier = "0";
	} else if (looks.abilityScore >= 13 && looks.abilityScore < 14) {
		looks.charismaModifier = "+1";
		looks.startingHonorModifier = "+1";
		looks.startingFameModifier = "0";
	} else if (looks.abilityScore >= 14 && looks.abilityScore < 15) {
		looks.charismaModifier = "+1";
		looks.startingHonorModifier = "+2";
		looks.startingFameModifier = "+1";
	} else if (looks.abilityScore >= 15 && looks.abilityScore < 16) {
		looks.charismaModifier = "+2";
		looks.startingHonorModifier = "+2";
		looks.startingFameModifier = "+2";
	} else if (looks.abilityScore >= 16 && looks.abilityScore < 17) {
		looks.charismaModifier = "+2";
		looks.startingHonorModifier = "+3";
		looks.startingFameModifier = "+3";
	} else if (looks.abilityScore >= 17 && looks.abilityScore < 18) {
		looks.charismaModifier = "+3";
		looks.startingHonorModifier = "+3";
		looks.startingFameModifier = "+5";
	} else if (looks.abilityScore >= 18 && looks.abilityScore < 19) {
		looks.charismaModifier = "+4";
		looks.startingHonorModifier = "+4";
		looks.startingFameModifier = "+7";
	} else if (looks.abilityScore >= 19 && looks.abilityScore < 20) {
		looks.charismaModifier = "+5";
		looks.startingHonorModifier = "+4";
		looks.startingFameModifier = "+8";
	} else if (looks.abilityScore >= 20 && looks.abilityScore < 21) {
		looks.charismaModifier = "+6";
		looks.startingHonorModifier = "+5";
		looks.startingFameModifier = "+9";
	} else {
		looks.charismaModifier = "NA";
		looks.startingHonorModifier = "NA";
		looks.startingFameModifier = "NA";	}
	document.getElementById("looksCharismaModifier").textContent=looks.charismaModifier;
	document.getElementById("looksStartingHonorModifier").textContent=looks.startingHonorModifier;
	document.getElementById("looksStartingFameModifier").textContent=looks.startingFameModifier;
...
function updateCharismaModifiers() {
	if (charisma.abilityScore >= 1 && charisma.abilityScore < 2) {
		charisma.bpBonus = "0";
		charisma.startingHonorModifier = "-6";
		charisma.turningModifier = "-9";
		charisma.moraleModifier = "-5";
		charisma.maximumProteges = "0";
	} else if (charisma.abilityScore >= 2 && charisma.abilityScore < 3) {
		charisma.bpBonus = "0";
		charisma.startingHonorModifier = "-5";
		charisma.turningModifier = "-8";
		charisma.moraleModifier = "-4";
		charisma.maximumProteges = "1";
	} else if (charisma.abilityScore >= 3 && charisma.abilityScore < 4) {
		charisma.bpBonus = "0";
		charisma.startingHonorModifier = "-4";
		charisma.turningModifier = "-7";
		charisma.moraleModifier = "-4";
		charisma.maximumProteges = "1";
	} else if (charisma.abilityScore >= 4 && charisma.abilityScore < 5) {
		charisma.bpBonus = "0";
		charisma.startingHonorModifier = "-3";
		charisma.turningModifier = "-6";
		charisma.moraleModifier = "-3";
		charisma.maximumProteges = "1";
	} else if (charisma.abilityScore >= 5 && charisma.abilityScore < 6) {
		charisma.bpBonus = "0";
		charisma.startingHonorModifier = "-3";
		charisma.turningModifier = "-5";
		charisma.moraleModifier = "-3";
		charisma.maximumProteges = "1";
	} else if (charisma.abilityScore >= 6 && charisma.abilityScore < 7) {
		charisma.bpBonus = "0";
		charisma.startingHonorModifier = "-2";
		charisma.turningModifier = "-4";
		charisma.moraleModifier = "-2";
		charisma.maximumProteges = "2";
	} else if (charisma.abilityScore >= 7 && charisma.abilityScore < 8) {
		charisma.bpBonus = "0";
		charisma.startingHonorModifier = "-2";
		charisma.turningModifier = "-3";
		charisma.moraleModifier = "-2";
		charisma.maximumProteges = "2";
	} else if (charisma.abilityScore >= 8 && charisma.abilityScore < 9) {
		charisma.bpBonus = "0";
		charisma.startingHonorModifier = "-1";
		charisma.turningModifier = "-2";
		charisma.moraleModifier = "-1";
		charisma.maximumProteges = "2";
	} else if (charisma.abilityScore >= 9 && charisma.abilityScore < 10) {
		charisma.bpBonus = "0";
		charisma.startingHonorModifier = "-1";
		charisma.turningModifier = "-1";
		charisma.moraleModifier = "-1";
		charisma.maximumProteges = "2";
	} else if (charisma.abilityScore >= 10 && charisma.abilityScore < 11) {
		charisma.bpBonus = "0";
		charisma.startingHonorModifier = "0";
		charisma.turningModifier = "0";
		charisma.moraleModifier = "0";
		charisma.maximumProteges = "3";
	} else if (charisma.abilityScore >= 11 && charisma.abilityScore < 12) {
		charisma.bpBonus = "0";
		charisma.startingHonorModifier = "0";
		charisma.turningModifier = "+1";
		charisma.moraleModifier = "+1";
		charisma.maximumProteges = "3";
	} else if (charisma.abilityScore >= 12 && charisma.abilityScore < 13) {
		charisma.bpBonus = "1";
		charisma.startingHonorModifier = "+1";
		charisma.turningModifier = "+2";
		charisma.moraleModifier = "+1";
		charisma.maximumProteges = "3";
	} else if (charisma.abilityScore >= 13 && charisma.abilityScore < 14) {
		charisma.bpBonus = "3";
		charisma.startingHonorModifier = "+1";
		charisma.turningModifier = "+3";
		charisma.moraleModifier = "+2";
		charisma.maximumProteges = "3";
	} else if (charisma.abilityScore >= 14 && charisma.abilityScore < 15) {
		charisma.bpBonus = "6";
		charisma.startingHonorModifier = "+2";
		charisma.turningModifier = "+4";
		charisma.moraleModifier = "+2";
		charisma.maximumProteges = "3";
	} else if (charisma.abilityScore >= 15 && charisma.abilityScore < 16) {
		charisma.bpBonus = "10";
		charisma.startingHonorModifier = "+2";
		charisma.turningModifier = "+5";
		charisma.moraleModifier = "+3";
		charisma.maximumProteges = "3";
	} else if (charisma.abilityScore >= 16 && charisma.abilityScore < 17) {
		charisma.bpBonus = "15";
		charisma.startingHonorModifier = "+3";
		charisma.turningModifier = "+6";
		charisma.moraleModifier = "+3";
		charisma.maximumProteges = "4";
	} else if (charisma.abilityScore >= 17 && charisma.abilityScore < 18) {
		charisma.bpBonus = "21";
		charisma.startingHonorModifier = "+3";
		charisma.turningModifier = "+7";
		charisma.moraleModifier = "+4";
		charisma.maximumProteges = "4";
	} else if (charisma.abilityScore >= 18 && charisma.abilityScore < 19) {
		charisma.bpBonus = "28";
		charisma.startingHonorModifier = "+4";
		charisma.turningModifier = "+8";
		charisma.moraleModifier = "+4";
		charisma.maximumProteges = "4";
	} else if (charisma.abilityScore >= 19 && charisma.abilityScore < 20) {
		charisma.bpBonus = "36";
		charisma.startingHonorModifier = "+4";
		charisma.turningModifier = "+9";
		charisma.moraleModifier = "+5";
		charisma.maximumProteges = "4";
	} else if (charisma.abilityScore >= 20 && charisma.abilityScore < 21) {
		charisma.bpBonus = "45";
		charisma.startingHonorModifier = "+5";
		charisma.turningModifier = "+10";
		charisma.moraleModifier = "+5";
		charisma.maximumProteges = "4";
	} else if (charisma.abilityScore >= 21 && charisma.abilityScore < 22) {
		charisma.bpBonus = "55";
		charisma.startingHonorModifier = "+5";
		charisma.turningModifier = "+11";
		charisma.moraleModifier = "+6";
		charisma.maximumProteges = "5";
	} else if (charisma.abilityScore >= 22 && charisma.abilityScore < 23) {
		charisma.bpBonus = "66";
		charisma.startingHonorModifier = "+6";
		charisma.turningModifier = "+12";
		charisma.moraleModifier = "+6";
		charisma.maximumProteges = "5";
	} else {
		charisma.bpBonus = "NA";
		charisma.startingHonorModifier = "NA";
		charisma.turningModifier = "NA";
		charisma.moraleModifier = "NA";
		charisma.maximumProteges = "NA";
	}
	document.getElementById("charismaBPBonus").textContent=charisma.bpBonus;
	document.getElementById("charismaStartingHonorModifier").textContent=charisma.startingHonorModifier;
	document.getElementById("charismaTurningModifier").textContent=charisma.turningModifier;
	document.getElementById("charismaMoraleModifier").textContent=charisma.moraleModifier;
	document.getElementById("charismaMaximumProteges").textContent=charisma.maximumProteges;
